...
inline SDL_Color ColorConvert(const color4_t& color4)
{
	...
	color.r = (uint8_t)(std::clamp(color4.r * 255.0f, 0.0f, 255.0f));
	color.g = (uint8_t)(std::clamp(color4.g * 255.0f, 0.0f, 255.0f)); 
	color.b = (uint8_t)(std::clamp(color4.b * 255.0f, 0.0f, 255.0f)); 
...
inline SDL_Color ColorConvert(const color3_t& color3)
{
	...
	color.r = (uint8_t)std::clamp(color3.r * 255.0f, 0.0f, 255.0f);
	color.g = (uint8_t)std::clamp(color3.g * 255.0f, 0.0f, 255.0f);
	color.b = (uint8_t)std::clamp(color3.b * 255.0f, 0.0f, 255.0f);
	color.a = 255;
